...
// 좋아요와 싫어요를 합한 상위 10개의 학교 이름을 가져오는 쿼리
$sql = "SELECT introId, SUM(introLike) AS Likes, SUM(introDislike) AS Dislikes
        FROM IntroLikes 
        GROUP BY introId 
...
$rankedUniforms = [];
foreach ($schoolViews as $schoolName => $views) {
    foreach ($uniforms as $uniform) {
        if ($uniform['school'] == $schoolName) {
            $uniform['likes'] = $schoolLikes[$schoolName]['likes'];
            $uniform['dislikes'] = $schoolLikes[$schoolName]['dislikes'];
                        ...
                        <div class="card__list">
                            <a href="../introduce/introDetail.php?introId=<?= $uniform['school'] ?>">
                                ...
                                <div class="card__list__text">
                                    <p class="region"><?= $uniform['region'] ?></p>
                                    <p class="school__name"><?= $uniform['school'] ?></p>
                                    <div class="views">
                                        <p class="view-count"><img src="../assets/img/view.svg" alt=""> <?= $uniform['views'] ?></p>
                                    </div>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="card__list">
                            <a href="../introduce/introDetail.php?introId=<?= $uniform['school'] ?>">
                                ...
                                <div class="card__list__text">
                                    ...
                                    <p class="school__name"><?= $uniform['school'] ?></p>
                                    <div class="views">
                                        <p class="view-count"><img src="../assets/img/good.svg" alt=""> <?= $uniform['likes'] ?></p>
                                    </div>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="card__list">
                            <a href="../introduce/introDetail.php?introId=<?= $uniform['school'] ?>">
                                ...
                                <div class="card__list__text">
                                    ...
                                    <p class="school__name"><?= $uniform['school'] ?></p>
                                    <div class="views">
                                        <p class="view-count"><img src="../assets/img/hate.svg" alt=""> <?= $uniform['dislikes'] ?></p>
                                    </div>
                                </div>
                            </a>
                        </div>
