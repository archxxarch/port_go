...
<?php
    ...
    if($blogImgType){
        ...
        echo "<script>alert('이미지 파일을 첨부하지 않고 저장합니다.')</script>";
        echo "<script>window.location.href = 'cummunity.php';</script>";
        $sql = "INSERT INTO blog(memberId, blogTitle, blogContents, blogCategory, blogAuthor, blogRegTime, blogView, blogLike, blogDelete) VALUES ('$memberId', '$blogTitle', '$blogContents', '$blogCategory', '$blogAuthor', '$blogRegTime', '$blogView', '$blogLike', '$blogDelete')";
    } 
