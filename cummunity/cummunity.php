        ...
        <section class="board__inner container">
            ...
            <div class="board__table">
                <table>
                    ...
                    <?php
                        $blogTotalCount; // Start from the total count and decrement
...
<div class="board__pages">
    <ul>
        ...
        //     echo "<li class='last'><a href='cummunity.php?page={$blogTotalCount}'><svg xmlns='http://www.w3.org/2000/svg' height='1em' viewBox='0 0 512 512'><style>svg{